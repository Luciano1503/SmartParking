...
class ValidacionStyles {
  ...
  static final Color glowCyan = const Color(0xFF00C6FF).withValues(alpha: 0.14);
  static final Color glowBlue = const Color(0xFF0072FF).withValues(alpha: 0.13);
  ...
  static BoxDecoration get otpBoxDecoration =>
      BoxDecoration(color: darkInput, borderRadius: BorderRadius.circular(12));
