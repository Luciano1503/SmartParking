...
class AppStyles {
  ...
  static final Color glowCyanStrong = const Color(
    0xFF00C6FF,
  ).withValues(alpha: 0.18);
  static final Color glowBlueSoft = const Color(
    0xFF0072FF,
  ).withValues(alpha: 0.15);
  static final Color glowCyanLight = const Color(
    0xFF00C6FF,
  ...
  static BoxDecoration get cardDecoration => BoxDecoration(
    color: cardBase.withValues(alpha: 0.85),
  ...
  static const TextStyle registerTextStyle = TextStyle(fontSize: 13);
  ...
  static ButtonStyle get registerTextButtonStyle =>
      TextButton.styleFrom(foregroundColor: primaryCyan);
}
