...
class AcercaDeStyles {
  ...
  // Paddings
  static const EdgeInsets appBarTitlePadding =
      EdgeInsets.only(left: 16, bottom: 14);

  static const EdgeInsets brandCardOuterPadding =
      EdgeInsets.fromLTRB(20, 24, 20, 0);

  static const EdgeInsets statsRowPadding =
      EdgeInsets.fromLTRB(20, 20, 20, 0);

  static const EdgeInsets sectionTopPadding =
      EdgeInsets.fromLTRB(20, 24, 20, 0);

  static const EdgeInsets techSectionPadding =
      EdgeInsets.fromLTRB(20, 28, 20, 14);

  static const EdgeInsets horizontalSectionPadding =
      EdgeInsets.symmetric(horizontal: 20);

  static const EdgeInsets ctaPadding =
      EdgeInsets.fromLTRB(20, 28, 20, 36);
  ...
  static const EdgeInsets statCardPadding =
  ...
  static BoxDecoration get heroGlowDecoration => BoxDecoration(
        ...
        gradient: RadialGradient(
          colors: [cyan.withOpacity(0.20), Colors.transparent],
        ),
      );
  ...
  static const TextStyle infoCardTextStyle = TextStyle(
    fontSize: 13,
    color: infoText,
    height: 1.6,
  );
  ...
  // Button styles
  static ButtonStyle get transparentIconButtonStyle =>
