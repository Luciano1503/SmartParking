...
class PremiumStyles {
  ...
  static const EdgeInsets headerPadding =
      EdgeInsets.fromLTRB(8, 4, 16, 24);
  static const EdgeInsets headerSubtitlePadding =
      EdgeInsets.fromLTRB(14, 4, 14, 0);
  static const EdgeInsets headerBadgePadding =
      EdgeInsets.symmetric(horizontal: 10, vertical: 5);
  static const EdgeInsets contentPadding =
      EdgeInsets.fromLTRB(16, 20, 16, 24);

  static const EdgeInsets cardHeaderPadding = EdgeInsets.all(20);
  static const EdgeInsets featuresPadding =
      EdgeInsets.fromLTRB(20, 16, 20, 0);
  static const EdgeInsets descriptionPadding =
      EdgeInsets.fromLTRB(20, 10, 20, 0);
  static const EdgeInsets descriptionInnerPadding =
  ...
  static BoxDecoration planCardDecoration({
    ...
    return BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(
          color: accentColor.withOpacity(isPrimary ? 0.14 : 0.07),
          blurRadius: 20,
  ...
  static BoxDecoration planHeaderDecoration({
    ...
    return BoxDecoration(
      gradient: isPrimary
          ...
          : null,
      color: isPrimary ? null : const Color(0xFFF8FBFF),
  ...
  static TextStyle planTitleStyle(bool isPrimary) => TextStyle(
        color: isPrimary ? Colors.white : titleDark,
        fontSize: 18,
        fontWeight: FontWeight.w800,
      );
  ...
  static TextStyle featureTextStyle(bool disabled) => TextStyle(
        color: disabled ? disabledText : textDark,
        fontSize: 13,
