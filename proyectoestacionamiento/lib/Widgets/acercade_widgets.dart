...
class HeroTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ShaderMask(
      ...
      child: Text(context.tr('about.title'), style: AcercaDeStyles.heroTitleTextStyle),
    );
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(context.tr('about.who_we_are'), style: AcercaDeStyles.sectionTitleStyle),
      ...
      child: Row(
        ...
        children: [
          const Icon(
            ...
            color: AcercaDeStyles.blue,
            size: 20,
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Text(
              context.tr('about.tech_description'),
