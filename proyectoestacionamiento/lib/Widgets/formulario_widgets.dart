...
class FormBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: isDark
          ? FormularioStyles.backgroundDecoration
          : const BoxDecoration(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(
              "SOLUTIONS",
              style: FormularioStyles.brandSubtitleStyle(context),
            ),
          ],
        ),
      ],
...
class FormPageTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          context.tr('form.title'),
          style: isDark
              ? FormularioStyles.pageTitleStyle
              : FormularioStyles.pageTitleStyle.copyWith(
                  color: const Color(0xFF0F1E3A),
                ),
        ),
        const SizedBox(height: 6),
        Text(
          context.tr('form.subtitle'),
          style: isDark
              ? FormularioStyles.pageSubtitleStyle
              : FormularioStyles.pageSubtitleStyle.copyWith(
    ...
    return Row(
      children: [
        ...
        Text(
          label,
          style: isDark
              ? FormularioStyles.sectionHeaderTextStyle
              : FormularioStyles.sectionHeaderTextStyle.copyWith(
                  color: const Color(0xFF0F1E3A),
                ),
        ),
      ],
...
class PasswordHint extends StatelessWidget {
  ...
  const PasswordHint({super.key, required this.text});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(text, style: FormularioStyles.passwordHintTextStyle(context)),
      ],
    );
  }
}
...
class PasswordRequirementsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: FormularioStyles.passwordRequirementsDecoration(context),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            context.tr('form.password_requirements'),
            style: FormularioStyles.passwordRequirementTitleStyle,
          ),
          const SizedBox(height: 8),
          PasswordHint(text: context.tr('form.min_twelve')),
          const SizedBox(height: 4),
          PasswordHint(text: context.tr('form.one_number')),
          const SizedBox(height: 4),
          PasswordHint(text: context.tr('form.special_character')),
        ],
      ),
    );
  }
      ...
      children: [
        ...
        const Padding(
          ...
          child: Text(
            ...
            style: TextStyle(
              fontSize: 28,
              color: FormularioStyles.primaryCyan,
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        maxLength: 1,
        style: TextStyle(
          color: isDark ? Colors.white : const Color(0xFF0F1E3A),
          fontSize: 18,
          fontWeight: FontWeight.bold,
        ),
        onChanged: onChanged,
          ...
          child: isLoading
              ...
              : Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(label, style: FormularioStyles.buttonTextStyle),
                  ],
                ),
        ),
      ),
