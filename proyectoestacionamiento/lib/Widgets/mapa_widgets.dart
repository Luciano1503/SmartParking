            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [
                          MapaStyles.primaryCyan,
                          MapaStyles.primaryBlue,
                        ],
                      ),
                  ...
                  GpsStatusBadge(active: gpsActive, loading: locationLoading),
                ],
              ),
              Padding(
                padding: MapaStyles.headerHelpPadding,
                child: Text(
                  context.tr('map.subtitle'),
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: MapaStyles.searchInputDecoration(context),
                        ),
                      ),
                    ),
                    const SizedBox(width: 10),
                    SearchButton(isSearching: isSearching, onPressed: onSearch),
                  ],
                ),
              ),
            ],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            loading
                ? context.tr('map.detecting')
                : active
                ? context.tr('map.gps_active')
                : context.tr('map.no_gps'),
      ...
      child: DecoratedBox(
        ...
        child: ElevatedButton(
          ...
          child: isSearching
              ...
              : Text(context.tr('map.search'), style: MapaStyles.searchButtonTextStyle),
        ),
      ),
    );
  }
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              loading
                  ? context.tr('map.detecting_location')
                  : context.tr('map.unavailable'),
              style: MapaStyles.placeholderTitleStyle,
            ),
            const SizedBox(height: 8),
            Text(
              context.tr('map.enable_help'),
              ...
              SizedBox(
                ...
                child: DecoratedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                      context.tr('map.enable_location'),
    ...
    return Tooltip(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Icon(icon, color: MapaStyles.primaryBlue, size: 22),
        ),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 6),
          Text(context.tr('map.user_location'), style: MapaStyles.legendTextStyle),
          ...
          const SizedBox(width: 6),
          Text(context.tr('map.search_legend'), style: MapaStyles.legendTextStyle),
        ],
      ),
    );
  }
